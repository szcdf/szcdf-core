...
# $# = 0
szcdf_preset__init() {
  declare -gA SZCDF_PRESET__IS_REGISTERED
  declare -ga SZCDF_PRESET__REGISTERED_PRESETS
  declare -gA SZCDF_PRESET__IS_REGISTERED_AS_DIR
  declare -gA SZCDF_PRESET__IS_REGISTERED_AS_SINGLE_SCRIPT

  declare -gA SZCDF_PRESET__IS_LOADED
  declare -ga SZCDF_PRESET__LOADED_PRESETS

  declare -gA SZCDF_PRESET__HAD_FAILURE
}
