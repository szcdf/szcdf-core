...
# Type: Preset
# Preset: set-shell-prompt-powerline-purple
# Purpose: Sets up the powerline prompt in purple.

szcdf_logging__begin_context 'core-presets/set-shell-prompt-powerline-purple'
